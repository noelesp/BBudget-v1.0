...
function update_span(content)
{
document.getElementById('money').innerHTML = "$" + document.getElementById("amount").value
}
...
<table width="520" cellpadding="5" cellspacing="0">
 ...
 <tr >
  ...
  <?PHP
	...
	$getdesc = 	'SELECT * FROM `bbudget_type` WHERE `desctype` LIKE \'%Ingreso%\' LIMIT 0, 30 ';
 ...
 <tr >
  ...
  <td class="right" >
   <input type="text" size="20" name="check" class="text" value="" id="check"  maxlength="100"  /><span id="chk"></span>
  </td>
 </tr>
 <tr >
  <td width="150" class="left" valign="top"  >
 ...
 <tr >
  ...
  <td class="right" >
   <input type="text" size="20" name="amount" class="text" value="0" id="amount"  style="color:green; font-weight: bold;"  maxlength="100"  /><span id="a"></span>
  </td>
 </tr>
 <tr >
  <td width="150" class="left" >
...
else if (bbudget.check.value.length==0)

document.getElementById("chk").innerHTML=" *Se necesita numero de cheque";
