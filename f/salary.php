 ...
 <tr >
  ...
  <td class="right" >
   ...
   ?>
   	...
   	<a HREF="javascript:popUp('http://iglesia-lilburn.org/f/person.php')">Agregar Persona<a/><span id="n"></span>
  </td>
 </tr>
 <tr >
  ...
  <?PHP
	...
	$getdesc = 'SELECT `desctype` FROM `bbudget_type` WHERE `desctype` = \'Salario\' ';
